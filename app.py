   ...
   # --- E. STRATEGIC INDICATORS (Row 2 - Reactive) ---
    ...
    with tab_map:
        ...
        with c_map:
            ...
            # Feature Layers (Selectable via Legend)
            ...
            # --- 5. MODERN HUD LEGEND (Floating Terminal) ---
            legend_html = '''
            ...
            <b style="letter-spacing: 2px;">HUD: MONITORING</b><hr style="border-color:#00f2ff; opacity:0.3;">
